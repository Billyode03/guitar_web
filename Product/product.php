...
<body>
    ...
    <div class="container-fluid bg-dark text-light"style="height: 100vh">
        <br><br><br>
        <p> <h2 class="text-center"> Data Product </h2></p>
        <br><br>
          <section class="login">
              <div class="container">
                  <div class="rw row g-5 rw"  style=" background-color: rgb(101, 96, 89)">
                      <div class="text-center col- py-5">
                          <div class="table_responsive">
                          <table class="table">
                              <thead class="tablehead">
                                  <tr class="tablerow">
                                      <th class="tabledata"> <b> Code </b></th>
                                      <th class="tabledata"> <b> Brand </b></th>
                                      <th class="tabledata"> <b> Type </b></th>
                                      <th class="tabledata"> <b> Stock </b></th>
                                      <th class="tabledata"> <b> Price </b></th>
                                      <th class="tabledata"> <b> Picture </b></th>
                                      <th class="tabledata"> <b> Action </b></th>
                                  </tr>
                              </thead>
                          <?php
                            include "../Home/koneksi.php";
                            $sql="select * from gitar";
                            ...
                            while ($data = mysqli_fetch_array($hasil))
                            {
                                ...
                                <tbody align="center">
                                    <tr>
                                        ...
                                        <td><img  height="150" src="<?php echo "data:image/jpeg;base64,".base64_encode($data["picture"]);   ?>" alt=""></td>
                                        <td>
                                            <span>
                                            <button class="action_btn"><a href="editData.php?code=<?php echo $data['code']; ?>">Edit</a></button>
                                            <button class="action_btn"><a href="delete.php?code=<?php echo $data['code']?>"> Delete </a></button>
                                            </span> 
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="text-center">
                            <br><br>
                            <p><button class="btn_1"><a href="inputData.php">Insert Data</a></button></p>
                        </div>
                      </div>
                  </div>
              </div>
