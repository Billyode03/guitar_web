                ...
                <div class="container">
                    <div class="rw_2 row g-0 rw col-6 offset-3">
                        <div class="text-center py-5">
                            <h2 style="color:black"> Ask Something </h2>
                            <form>
                                <div class="form-row py-2 pt-5">
                                    <div class="offset-1 col-lg-10">
                                        <input type="text" class="input px-3 text-center" placeholder="Username" >
                                    </div>
                                </div>
                                <div class="form-row py-3">
                                    <div class="offset-1 col-lg-10">
                                        <input type="password" class="input px-3 text-center" placeholder="Password">
                                    </div>
                                </div>
                                <div class="form-row py-2">
                                    <div class="offset-1 col-lg-10">
                                        <textarea class="input px-3 text-center" name="" id="" cols="30" rows="10" placeholder=" Write what do you want "></textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="container text-center text-md-left">
            <div class="row text-center text-md-left">
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat a beatae tempore harum 
                        at id voluptas, eos maiores aperiam cumque nemo iusto soluta ducimus unde impedit? Iure eos quia saepe?</p>
                </div>
            </div>      
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3 ">
                ...
                <p>
                    <i class="fas fa-home mr-3"> New York, NY 2333, US </i> 
                </p>
                <p>
                    <i class="fas fa-home mr-3"> theprovider@gmail.com </i>
                </p>
                <p>
                    <i class="fas fa-home mr-3"> +92 31628588445 </i>
                </p>
                <p>
                    <i class="fas fa-home mr-3"> New York, NY 2333, US</i>
                </p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 col-lg-4">
                    ...
                    <ul class="list-unstyled list-item">
                      <li class="list-inline-item">
                          <a href="#" class="btn-floating btn-sm text-white" style="font-size: 23px;"><i class="fab fa-linked-in"></i></a>
                      </li>
                    </ul>
                    <ul class="list-unstyled list-item">
                      <li class="list-inline-item">
